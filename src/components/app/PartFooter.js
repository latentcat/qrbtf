    ...
    <div className="Qr-titled">
        <div className="Qr-Centered Qr-footer note-font">
            <div>
                ...
                <span><a onClick={ (e) =>  handleLink(e.target.href)  } href="https://www.yuque.com/qrbtf/docs/contact" rel="noopener noreferrer" target="_blank">联系我们</a><span className="gray">&ensp;丨&ensp;</span></span>
            ...
            <div className="Qr-footer-part">
                ...
                <span><a onClick={ (e) =>  handleLink(e.target.href)  } href="https://mdnice.com" rel="noopener noreferrer" target="_blank">mdnice 公众号排版</a><span className="gray">&ensp;丨&ensp;</span></span>
                <span><a onClick={ (e) =>  handleLink(e.target.href)  } href="https://urlify.cn/" rel="noopener noreferrer" target="_blank">Urlify 短链接</a><span className="gray">&ensp;丨&ensp;</span></span>
                <span><a onClick={ (e) =>  handleLink(e.target.href)  } href="https://imgkr.com/" rel="noopener noreferrer" target="_blank">imgkr 图壳图床</a><span className="gray">&ensp;丨&ensp;</span></span>
